...
export default function Keyboard({setActiveApp}) {
  ...
  return (
    ...
    >
      {/* Keyboard body */}
      <div className="absolute inset-0 translate-y-3 bg-gray-900 rounded-4xl" />
      <div className="absolute inset-0 bg-gradient-to-b from-red-800 to-red-900 rounded-3xl" />
